...
class CompanyItem extends StatelessWidget {
  const CompanyItem(this.companyModel);
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(
            children: [
              ...
              Padding(
                padding:
                    EdgeInsets.only(top: 5.0, left: 0.0, right: 5.0, bottom: 5),
                child: Text(
              ...
              Padding(padding: EdgeInsets.only( top: 5.0, left: 5.0, right: 10.0, bottom: 5),
              child: Column(
